...
const CreateAssistantModal: FC<CreateAssistantModalProps> = ({
  onClose,
  onCreate
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newAssistant: Assistant = {
      ...
      model,
      instructions,
      avatar: '', // Would ideally allow uploading avatar
      thread_location: '',
      file_ids: [],
      tools: [
        {
    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <div className="bg-[hsla(var(--app-bg))] rounded-lg p-6 w-full max-w-md">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-medium">Create New Assistant</h2>
          <Button
            variant="outline"
            size="small"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* This would ideally be a dropdown with available models */}
          <div>
            <label className="block text-sm font-medium mb-2">
              Model Preference
            </label>
